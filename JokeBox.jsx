  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
        <button onClick={() => roll('joke')} style={tabStyle(mode === 'joke')}>Joke</button>
        <button onClick={() => roll('riddle')} style={tabStyle(mode === 'riddle')}>Riddle</button>
      </div>
...
function tabStyle(active) {
  return {
    ...
    background: active ? 'var(--ink)' : 'var(--paper-dim)',
