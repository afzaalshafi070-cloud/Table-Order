...
export default function OrderCard({ order, hasWaterAlert, hasWaiterAlert, onAccept, onServe, onResolveAlert }) {
  ...
  return (
    <div className="ticket-in" style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
        <strong style={{ fontFamily: 'var(--mono)', fontSize: 14 }}>Table {order.table_id}</strong>
