...
export default function CustomerPortal() {
  ...
  useEffect(() => {
    ...
    async function resolveSession() {
      ...
      if (error || !data) {
        ...
        // Restore only ACTIVE (not completed) orders for this table/QR — so refresh/re-scan still shows them
  ...
  const rateOrder = async (orderId, stars) => {
    ...
    // After rating, drop from active list (history clear)
